...
import { Trophy, Clock, FileText, Users, Activity, FileDown, Code2, AlertOctagon, X, RefreshCw, MonitorPlay, Settings2, Trash2, Award } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { path: 'conclusion',  icon: <Award size={20} />,       label: 'Conclusion' },
